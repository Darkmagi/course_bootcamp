import 'package:course_bootcamp/database_helper.dart';
import 'package:course_bootcamp/example_5/example_5_form_page.dart';
...
class _Example5PageState extends State<Example5Page> {
  ...
  Widget _body() {
    ...
    return ListView(
        children: listTasks!
            .map((task) => Text("${task.name}, Seconds: ${task.seconds}"))
            .toList());
  }
  ...
  Widget _fabGoToForm() {
    return FloatingActionButton.extended(
        onPressed: () => Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => Example5FormPage()))
